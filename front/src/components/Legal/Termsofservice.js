...
export default function Termsofservice() {
    return (
        <div style={{padding:"25px"}} className="termsofservice">
            <h3>TERMS OF SERVICE </h3>
            <br /><br />
            <h3>OVERVIEW 
</h3>
<p>
This website is operated by factify. Throughout the site, the terms “we”,
“us” and “our” refer to factify. factify offers this website, including all
...
<p>By visiting our site and/ or purchasing something from us, you engage in
...
customers, merchants, and/ or contributors of content. </p><br />
<p>
...
<h3>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS
OF INFORMATION </h3>
        <p>
...
service made on this site is void where prohibited.<br />
...
<h3>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT
INFORMATION </h3>
<p>We reserve the right to refuse any order you place with us. We may, in
...
websites, or for any other materials, products, or services of thirdparties.<br />
...
connection with any third-party websites. Complaints, claims, concerns,
or questions regarding third-party products should be directed to the
third-party. </p>
<h3>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER
SUBMISSIONS </h3>
<p>
...
comments; or (3) to respond to any comments.<br />
...
libellous, defamatory, pornographic, obscene or otherwise objectionable
or violates any party’s intellectual property or these Terms of Service.<br />
You agree that your comments will not violate any right of any thirdparty, including copyright, trademark, privacy, personality or other
...
by our Privacy Policy. To view our Privacy Policy</p>
...
cancel orders if any information in the Service or on any related website
is inaccurate at any time without prior notice (including after you have
submitted your order). <br />
...
<h3>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF
LIABILITY </h3>
<p>We do not guarantee, represent or warrant that your use of our service
...
In no case shall factify, our directors, officers, employees, affiliates,
...
<p>You agree to indemnify, defend and hold harmless factify and our parent,
...
<p>In the event that any provision of these Terms of Service is determined
...
Terms of Service shall not constitute a waiver of such right or provision.<br />
...
<p>You can review the most current version of the Terms of Service at any
...
info@joinfactify.com, info@allang.org</p>
        </div>
    )
}
